...
const AboutWithSkills = ({ user }) => {
  ...
  return (
    <section
      id="about"
      className="relative overflow-hidden bg-gradient-to-br from-black via-[#0a0a12] to-[#1a1a2e]"
    >
      {/* Cosmic background */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 py-12 sm:py-16 md:py-14 ">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start lg:items-stretch ">
          ...
          <div className="space-y-12 flex flex-col justify-between">
            ...
            >
              <div>
                <h3 className="text-4xl font-bold tracking-tight text-white mb-2 text-center lg:text-start">
                  {user.length !== 0 ? (
                    <>
                ...
                <div className="text-sm sm:text-base text-gray-400 font-mono mb-6 text-center lg:text-start">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  {stats.map((stat, i) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="bg-black/40 border border-white/10 rounded-xl p-4 backdrop-blur-sm"
                    >
              ...
              <div className="space-y-4 text-gray-400 2xl:text-lg text-[13px]">
                <p className="leading-relaxed border-l-2 border-cyan-400/50 pl-4">
