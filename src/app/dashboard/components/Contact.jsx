...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      ref={container}
      className="contact-section relative min-h-screen py-20 sm:py-24 md:py-32 bg-neutral-950 text-white overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <div className="contact-header mb-12 sm:mb-16 md:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-white leading-tight tracking-tight max-w-3xl">
